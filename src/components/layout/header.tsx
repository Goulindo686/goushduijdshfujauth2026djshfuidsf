...
export function Header({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
    <header className="h-16 border-b border-[#1C1C1F] bg-[#070708]/80 backdrop-blur-md sticky top-0 z-40">
      <div className="w-full max-w-[1600px] mx-auto px-6 md:px-8 h-full flex items-center justify-between">
        <div>
